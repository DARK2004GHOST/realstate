            ...
            ?>
                        <div class="col">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">$<?= number_format($reg['Precio']); ?> COP <a href="guardar_inmueble.php"><button type="button" class="btn btn-light" id="bookmark-button-<?= $idInmueble ?>">
                                                <i id="bookmark-icon-<?= $idInmueble ?>" class="bi bi-bookmark"></i>
                                                <!-- Agregar un espacio en blanco como contenido del enlace -->
