            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="../login/pagina_html/index.php">Inicio</a>
                        </li>
                        ...
                        <li class="nav-item mr-1">
                            <a class="nav-link" href="../login/pagina_html/pruebas.php">Pruebas</a>
                        </li>
                        </li>
                            </li>
                            <li class="nav-item">
                            <button type="button" class="btn btn-dark" style="height:40px; padding: 0;">
                                <a class="nav-link" href="../login/pagina_html/login.php" style="color: inherit;">Iniciar sesion</a>
                            </button>
                        </li>
                    </ul>
                </div>
    ...
    <section class="carrusel-casas" id="carouselExampleAutoplaying">
        ...
        <div id="slider-casas" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="../login/imagenes/carrusel/imagencarrusel4.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
...
<section class="container mt-4">
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6 pt-4 pt-lg-0 order-1 order-lg-1 content text-center" data-aos="fade-left">
                    <img src="../login/imagenes/informacion.jpg" class="img-fluid" alt="Imagen Informativa">
                </div>
  ...
  <i id="bookmark-icon" class="bi bi-bookmark" data-bs-toggle="tooltip" data-bs-placement="right" title="Debes iniciar sesión para acceder a esta opción"></i>
                            ...
                            <p class="card-text"><?= $reg['Localidad']; ?></p>
                            <a href="../login/crudinmuebles/interfazinmuebles.php $reg['IdInmueble'] ?>" class="btn btn-dark">Más Detalles</a>
                        </div>
                    </div>
                </div>
        <?php
